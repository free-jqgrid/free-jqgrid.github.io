...
<!--@@commonHeadIncludes-->
	...
	$(function () {
		$("#showImages").click(function() {
			$(".imageExample")[$(this).is(":checked") ? "show": "hide"]()
		});
	});
	</script>
</head>
...
<div class="container">
	...
	<ul>
		<li><a href="http://www.ok-soft-gmbh.com/jqGrid/OK/CustomActionButton.htm">Display additional custom buttons</a>
			<img src="CustomActionButton.png" class="imageExample" style="display:none" alt="Display additional custom buttons" /></li>
		<li><a href="http://www.ok-soft-gmbh.com/jqGrid/OK/CustomActionButton1.htm">Hide some actions buttons</a>
			<img src="CustomActionButton1.png" class="imageExample" style="display:none" alt="Hide some actions buttons" />
			<p>See <a href="http://stackoverflow.com/a/29735149/315935">the answer</a> for details</p></li>
	</ul>
	<h3>Select rows:</h3>
	<ul>
		<li><a href="http://www.ok-soft-gmbh.com/jqGrid/OK/multiPageSelection.htm">Usage of <l-js>multiPageSelection: true</l-js> option</a>. It allows to maintains selection of rows over multiple pages on the grid.
			<img src="multiPageSelection.png" class="imageExample" style="display:none" alt="Select rows using multiPageSelection option" />
			<p>See <a href="http://stackoverflow.com/a/33021115/315935">the answer</a> for details</p></li>
	</ul>
	<h3>Inline editing:</h3>
	<ul>
		<li><a href="http://www.ok-soft-gmbh.com/jqGrid/OK/focusOfEditRow.htm">Usage of <l-js>focusField</l-js> option of <l-js>editRow</l-js> method</a>. It allows very easy start inline editing with setting the focus on the cell clicked by the user. 
			<img src="focusOfEditRow.png" class="imageExample" style="display:none" alt="Usage of focusField option of editRow" />
			<p>See <a href="http://stackoverflow.com/a/31162434/315935">the answer</a> for details</p></li>
	</ul>
